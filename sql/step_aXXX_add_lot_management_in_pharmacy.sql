...
INSERT INTO OH_MENUITEM (MNI_ID_A, MNI_BTN_LABEL, MNI_LABEL, MNI_TOOLTIP, MNI_SHORTCUT, MNI_SUBMENU, MNI_CLASS, MNI_IS_SUBMENU, MNI_POSITION) VALUES ('lotmanagement','angal.menu.btn.lotmanagement','angal.menu.lotmanagement','x','L','pharmacy','org.isf.medicalstock.gui.LotBrowser','N',7);
