CREATE TABLE OH_MEDICALDSRINVENTORY (
	...
	MINVT_CHARGE_TYPE varchar(10) NULL DEFAULT NULL,
	MINVT_DISCHARGE_TYPE varchar(10) NULL DEFAULT NULL,
	MINVT_SUPPLIER int NULL DEFAULT NULL,
	MINVT_DESTINATION varchar(1) NULL DEFAULT NULL,
