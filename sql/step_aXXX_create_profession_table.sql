...
-- Register the Profession browser in the menu so existing installations can manage the lookup table.
-- INSERT IGNORE keeps a fresh install idempotent (the row is already provided by step_02_dump_menu.sql).
...
INSERT IGNORE INTO OH_GROUPMENU (GM_UG_ID_A, GM_MNI_ID_A, GM_ACTIVE) VALUES ('admin', 'profession', '1');
