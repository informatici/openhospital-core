...
--   SELECT P_NAME, COUNT(*) AS cnt FROM OH_PERMISSIONS GROUP BY P_NAME HAVING cnt > 1;
--   SELECT GP_UG_ID_A, GP_P_ID_A, COUNT(*) AS cnt FROM OH_GROUPPERMISSION GROUP BY GP_UG_ID_A, GP_P_ID_A HAVING cnt > 1;
