...
(NULL, 'ORTHANCBASEURL', 'text', NULL, '', '', NULL, 'admin', NULL, NOW(), NULL, 1, 1, 'integration'),
(NULL, 'ORTHANCEXPLORERURL', 'text', NULL, '', '', NULL, 'admin', NULL, NOW(), NULL, 1, 1, 'integration'),
(NULL, 'ORTHANCUSERNAME', 'text', NULL, '', '', NULL, 'admin', NULL, NOW(), NULL, 1, 1, 'integration'),
(NULL, 'ORTHANCPASSWORD', 'text', NULL, '', '', NULL, 'admin', NULL, NOW(), NULL, 1, 1, 'integration'),
(NULL, 'ORTHANCENABLED', 'bool', NULL, 'FALSE', 'FALSE', NULL, 'admin', NULL, NOW(), NULL, 1, 1, 'integration');
