...
public interface OperationIoOperationRepository extends JpaRepository<Operation, String> {
	...
	@Query(value = "SELECT * FROM OH_OPERATION JOIN OH_OPERATIONTYPE ON OPE_OCL_ID_A = OCL_ID_A WHERE OPE_FOR LIKE 1 OR OPE_FOR='OPD' OR OPE_FOR='ADMISSION' ORDER BY OPE_DESC", nativeQuery = true)
