...
public class JasperReportsManager {
	...
	public JasperReportResultDto getExamsListPdf() throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, null, "pdf");
			...
			// Any exception
			LOGGER.error("", e);
			throw new OHReportException(e, new OHExceptionMessage(MessageBundle.getMessage(COMMON_ERROR_TITLE),
	...
	public JasperReportResultDto getGenericReportAdmissionPdf(int admID, int patID, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(String.valueOf(patID)), "pdf");
	...
	public JasperReportResultDto getGenericReportBillZPL(Integer billID, String jasperFileName, boolean show, boolean askForPrint) throws OHServiceException {
		...
		try {
			...
			String txtFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(String.valueOf(billID)), "txt");
	...
	public JasperReportResultDto getGenericReportBillPdf(Integer billID, String jasperFileName, boolean show, boolean askForPrint) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(String.valueOf(billID)), "pdf");
	...
	public JasperReportResultDto getGenericReportOpdPdf(int opdID, int patID, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(String.valueOf(opdID)), "pdf");
	...
	public JasperReportResultDto getGenericReportPatientExaminationPdf(Integer patientID, Integer examId, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(String.valueOf(patientID)), "pdf");
	...
	public JasperReportResultDto getGenericReportWardVisitPdf(String wardID, LocalDateTime date, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(String.valueOf(wardID), TimeTools.formatDateTime(date, YYYY_M_MDD)), "pdf");
			...
			// Any exception
			LOGGER.error("", e);
			throw new OHServiceException(e, new OHExceptionMessage(MessageBundle.getMessage(COMMON_ERROR_TITLE),
					MessageBundle.getMessage(STAT_REPORTERROR_MSG), OHSeverityLevel.ERROR));
		}
	}
	...
	public JasperReportResultDto getGenericReportPharmaceuticalOrderPdf(String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(todayFile), "pdf");
	...
	public JasperReportResultDto getGenericReportPharmaceuticalStockPdf(LocalDateTime date, String jasperFileName, String filter, String groupBy, String sortBy)
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(dateFile), "pdf");
	...
	public JasperReportResultDto getGenericReportUserInDatePdf(String fromDate, String toDate, String aUser, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(aUser, date), "pdf");
	...
	public JasperReportResultDto getGenericReportUserInDateTxt(String fromDate, String toDate, String aUser, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String txtFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(aUser, date), "txt");
	...
	public JasperReportResultDto getGenericReportDischargePdf(int admID, int patID, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(RPT_BASE, jasperFileName, Arrays.asList(String.valueOf(admID)), "pdf");
	...
	/************* NICOLE ***************/
	public JasperReportResultDto getGenericReportFromDateToDatePdf(LocalDate fromDate, LocalDate toDate, String jasperFileFolder, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(jasperFileFolder, jasperFileName, null, "pdf");
	...
	public JasperReportResultDto getGenericReportFromDateToDatePdf(String fromDate, String toDate, String jasperFileFolder, String jasperFileName) throws OHServiceException {
	...
	public void getGenericReportFromDateToDateExcel(LocalDate fromDate, LocalDate toDate, String jasperFileFolder, String jasperFileName, String exportFilename) throws OHServiceException {
	...
	public void getGenericReportFromDateToDateExcel(String fromDate, String toDate, String jasperFileFolder, String jasperFileName, String exportFilename) throws OHServiceException {
	...
	public JasperReportResultDto getGenericReportMYPdf(Integer month, Integer year, String jasperFileFolder, String jasperFileName) throws OHServiceException {
		...
		try {
			...
			String pdfFilename = compileFilename(jasperFileFolder, jasperFileName, Arrays.asList(String.valueOf(year), String.valueOf(month)), "pdf");
	...
	public void getGenericReportMYExcel(Integer month, Integer year, String jasperFileFolder, String jasperFileName, String exportFilename) throws OHServiceException {
	...
	/***************** NICOLE *************/
	private HashMap<String,Object> compileGenericReportMYParameters(Integer month, Integer year, String jasperFileFolder, String jasperFileName) throws OHServiceException {
		HashMap<String, Object> parameters = getHospitalParameters();
		addBundleParameter(jasperFileFolder, jasperFileName, parameters);
	...
	private void addReportBundleParameter(String jasperParameter, String jasperFileFolder, String jasperFileName, Map<String, Object> parameters) {
		try {
			ResourceBundle resourceBundle = ResourceBundle.getBundle(
					jasperFileFolder + File.separator +jasperFileName, 
	...
	private static Date toDate(LocalDate localDate) {
		return Optional.ofNullable(localDate)
				.map(t -> Date.from(t.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()))
				.orElse(null);
