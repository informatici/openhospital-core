...
public class OpdBrowserManager {
	...
	protected void validateOpd(Opd opd, boolean insert) throws OHDataValidationException {
		...
		if (opd.getDate() == null) opd.setDate(new Date((new java.util.Date()).getTime()));
	 ...
	 * @throws OHServiceException 
	 */
	public ArrayList<Opd> getOpd(String diseaseTypeCode,String diseaseCode, Date dateFrom, Date dateTo,int ageFrom, int ageTo,char sex,char newPatient) throws OHServiceException {
