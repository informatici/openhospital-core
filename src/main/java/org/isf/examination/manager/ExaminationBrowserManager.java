...
public class ExaminationBrowserManager {
	...
	private DescriptionUtil descriptionUtil = new DescriptionUtil(diuresisDescriptionHashMap, bowelDescriptionHashMap);
	...
	protected void validateExamination(PatientExamination patex)  throws OHDataValidationException {
		buildAuscultationHashMap();
		descriptionUtil.buildBowelDescriptionHashMap();
		descriptionUtil.buildDiuresisDescriptionHashMap();
